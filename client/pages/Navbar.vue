        ...
        <header class="nav-opt-sprite nav-locate-us nav-lang-en nav-ssl nav-unrec">
            <div class="container-fluid dekstop-nav">
                <div class="row">
                    <div class="col-sm-2">
                        <div class="logo-area">
                            <a href="#">
                            <img src="/img/logo-black1.png " alt="logo" class="img-fluid"/>
                            </a>
                        </div>
                    </div> 
                     <!-- Search bar -->
            ...
            <div class="nav-global-location">
              <nuxt-link to="/address" class="nav-a nav-a-2">
                ...
                <div id="glow-ingress-block">
                  ...
                  <span class="nav-line-2" id="glow-ingress-line1">India</span>
                </div>
              </nuxt-link>
            </div>
          </div>
          ...
          <!-- Accounts and order -->
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-4 p-0">
                <div class="nav-tools">
                    <a href="#" id="icp-nav-flyout" class="nav-a nav-a-2 icp-link">
